...
resource "aws_autoscaling_group" "example_asg" {
  ...
  vpc_zone_identifier = ["subnet-0e85a62132fcb62cb", "subnet-0a6c6e35a58f5dbf6"]
  min_size            = 1
  max_size            = 3
  desired_capacity    = 2
...
resource "aws_lb" "my_lb" {
  ...
  subnets            = ["subnet-0e85a62132fcb62cb", "subnet-0a6c6e35a58f5dbf6"]  # Subnets to use for the load balancer
